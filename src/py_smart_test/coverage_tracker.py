...
def update_coverage_from_pytest_run(coverage_file: Path) -> None:
    ...
    This function reads a coverage.py data file and extracts which tests
    executed which source files.
    ...
    try:
        ...
        logger.warning("coverage library not found. Install with: pip install coverage")
        return
